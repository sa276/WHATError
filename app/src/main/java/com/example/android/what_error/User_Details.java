...
import static com.example.android.what_error.MainActivity.dummy_password;
import static com.example.android.what_error.MainActivity.dummy_username;
...
ArrayList<String>name_ar=new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user__details);
         ...
         tv2=findViewById(R.id.state_input);
         tv3=findViewById(R.id.city_input);
         tv4=findViewById(R.id.area_input);
         tv5=findViewById(R.id.contact_input);
    ...
    public static void display()
    {
        ...
        client.post("https://quizkrieg.000webhostapp.com/display_details.php",params, new AsyncHttpResponseHandler() {
            @Override
