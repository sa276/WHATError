...
public void displayall()
{
    ...
    client.post("https://quizkrieg.000webhostapp.com/alldetails.php",params, new AsyncHttpResponseHandler() {
        @Override
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
...
public void display_alldetails(String name_to_extract)
{
    ...
    client.post("https://quizkrieg.000webhostapp.com/display_all_details.php",params, new AsyncHttpResponseHandler() {
        @Override
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
            name=new String(responseBody);
            log.v("name",name);
